...
/// D=1 typed prelude: aliases `D0` to `d0` and skips the shape read.
...
/// D=2 typed prelude: aliases `D0, D1` to `d0, d1` and skips the shape read.
...
/// D=3 typed prelude: aliases `D0, D1, D2` to `d0, d1, d2` and skips the shape read.
...
/// D=4 typed prelude: aliases `D0..D3` to `d0..d3` and skips the shape read.
