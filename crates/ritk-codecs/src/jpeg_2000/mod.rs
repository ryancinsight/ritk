...
#[allow(dead_code, reason = "ratchet RITK-LINT-1")] // Tested via soc_marker_constant_matches_iso_15444_1
pub(crate) const SOC: u16 = 0xFF4F;

/// JPEG / JFIF Start of Image marker (0xFFD8), distinct from SOC.
#[allow(dead_code, reason = "ratchet RITK-LINT-1")] // Tested via soi_constant_matches_jpeg_start_of_image
