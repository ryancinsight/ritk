...
pub use format::dicom::{
    ...
    scan_dicom_directory, scan_dicom_files, scan_dicom_instances, scan_dicom_part10_bytes,
    scan_dicom_path, write_dicom_multiframe, write_dicom_multiframe_native,
