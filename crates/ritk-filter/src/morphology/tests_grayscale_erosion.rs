...
#[test]
fn native_erosion_preserves_geometry_and_matches_kernel() {
    ...
    let output = GrayscaleErosion::new(1)
        .apply_native(&image, &SequentialBackend)
        .expect("native grayscale erosion succeeds");
