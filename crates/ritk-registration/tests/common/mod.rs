...
//! every item is "dead" in some binaries. The `#[expect(dead_code, reason = "ratchet RITK-LINT-1")]` is a
...
#[expect(clippy::too_many_arguments, reason = "ratchet RITK-LINT-1")] // 8-arg test helper; flat signature reads cleanly
