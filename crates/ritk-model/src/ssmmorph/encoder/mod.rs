...
//!          â–¼
//!    ┌─────────────┐
//!    │   Stage 0   │──â–º Skip 0: [batch, 32, D, H, W]
//!    │  2 blocks   │
//!    └─────────────┘
//!          │ downsample
//!          â–¼
//!    ┌─────────────┐
//!    │   Stage 1   │──â–º Skip 1: [batch, 64, D/2, H/2, W/2]
//!    │  2 blocks   │
//!    └─────────────┘
//!          │ downsample
//!          â–¼
//!    ┌─────────────┐
//!    │   Stage 2   │──â–º Skip 2: [batch, 128, D/4, H/4, W/4]
//!    │  2 blocks   │
//!    └─────────────┘
//!          │ downsample
//!          â–¼
//!    ┌─────────────┐
//!    │   Stage 3   │──â–º Skip 3: [batch, 256, D/8, H/8, W/8]
//!    │  2 blocks   │
//!    └─────────────┘
//!          │
//!          â–¼
