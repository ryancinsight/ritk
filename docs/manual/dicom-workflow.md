...
These aspect and fusion tests do not establish rotated cursor/orientation
semantics or physical measurement accuracy outside the annotation APIs' numeric
range; the [coordinate item](../../backlog.md#RITK-SNAP-COORDINATES-001) owns
those checks.
