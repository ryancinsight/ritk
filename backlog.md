...
- Verification: dependency-free script tests, browser syntax/fixture checks, locked native/WASM package gates, and hosted responsive raster evidence. Hosted run [35704771969](https://github.com/ryancinsight/ritk/actions/runs/35704771969) passes Chromium and Firefox responsive jobs against RITK `620c0334` and Metis `219143bb`; exact trace and derivative hashes are in `docs/manual/images/dicom-metis-real-browser-mri-responsive.json`.
...
- Risk: [patch]; this is a dependency/provenance advance only. Diagnostic dispatch `35703095989` correctly exposed the old-lock exact-revision guard; the merged-main hosted dispatch `35704771969` is the current evidence record and retains explicit WebKit and WebGPU capability residuals.
...
- Evidence: current hosted [run 35704771969](https://github.com/ryancinsight/ritk/actions/runs/35704771969) builds RITK `620c03342f3951366441f1f908d05bc3f249f566` against Metis `219143bbf3596aea85fa4624d7d5241a63b4cf0d`; Chromium and Firefox pass the 94-file real MRI study, three exact pixel oracles and lifecycle checks; WebKit accepts the chooser but denies the first bounded read under Safari 26.6.2, with diagnostics artifact [10683463342](https://github.com/ryancinsight/ritk/actions/runs/35704771969/artifacts/10683463342) preserved in the provenance JSON.
...
- Blocker: exact SafariDriver/WebKit selected-file authorization defect remains external; current run 35704771969 reproduces the denial after SafariDriver accepts all 94 files (artifact [10683583337](https://github.com/ryancinsight/ritk/actions/runs/35704771969/artifacts/10683583337), diagnostics [10683463342](https://github.com/ryancinsight/ritk/actions/runs/35704771969/artifacts/10683463342)). Re-open when the corrected browser/runner path grants real-file reads; application byte-read APIs cannot grant that access.
...
- Blocker: hosted Chromium in run [35704771969](https://github.com/ryancinsight/ritk/actions/runs/35704771969) reports no WebGPU adapter; the setup error and failure capture artifact [10683659854](https://github.com/ryancinsight/ritk/actions/runs/35704771969/artifacts/10683659854) are preserved in [`dicom-metis-real-browser-mri-webgpu-failure.png`](docs/manual/images/dicom-metis-real-browser-mri-webgpu-failure.png).
