...
- Browser handoff increment: the WASM launch mounts `metis-web`, drains its bounded named-byte batch into RITK's existing dropped-input classifier, and documents the HTML/JavaScript bootstrap. RITK remains the only DICOM owner. The standalone locked `wasm32-unknown-unknown` check and warning-denied Clippy pass after the merged [Mnemosyne #141](https://github.com/ryancinsight/Mnemosyne/pull/141) (`01f0bc59`), [Coeus #393](https://github.com/ryancinsight/Coeus/pull/393) (`1140ee7f`), [Apollo #386](https://github.com/ryancinsight/apollo/pull/386) (`f8085085`), and [Leto #187](https://github.com/ryancinsight/leto/pull/187) (`569a32b8`) portability fixes.
