...
- Status: in-progress; priority: P1; owner: RITK viewer + Métis framework; integrator: root; regions: `crates/ritk-snap/src/browser_trace.rs`, `crates/ritk-snap/src/browser_trace/tests.rs`, `crates/ritk-snap/src/browser_trace/validation.rs`, `crates/ritk-snap/src/app/browser_semantics.rs`, `crates/ritk-snap/src/app/tests/browser_semantics.rs`, `crates/ritk-snap/src/app/web_viewer.rs`, `crates/ritk-snap/src/main.rs`, `crates/ritk-snap/tests/fixtures/browser-trace.json`, `.github/workflows/metis-browser-dicom.yml`, `docs/manual/dicom-workflow.md`, `docs/adr/0033-browser-trace-validator.md`, `docs/adr/0032-browser-semantic-snapshot.md`, `backlog.md`; last-update: 2026-09-15; branch: `feat/ritk-browser-cine-rate-trace`;
