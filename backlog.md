...
- Branch: `feat/ritk-snap-installer-evidence-001`; regions: `metis.json`, `docs/manual/dicom-workflow.md`, `docs/manual/images/dicom-metis-installer.json`; acceptance extension: a lock-pinned Metis package contains the RITK executable, inventory and MSI, and the portable executable opens a real saved DICOM study. DICOM behavior remains RITK-owned.
- lease: root `metis.json`, `docs/manual/dicom-workflow.md`, `docs/manual/images/dicom-metis-installer.json` — 2026-09-13T14:15:00-04:00
