...
- Dependency-lock increment (2026-09-15): all six Metis packages now resolve to merged Metis `305f24785b623a46b1962e73474a1a18dc6b3721` (PR #152), and all fifteen Moirai packages advance to current main `4aa9b394ba5de09c561162d8be73b55ee59e20a6`. The standalone lock, WASM, strict Clippy, native and `ritk-snap` gates remain required before the hosted replay; the workflow default is pinned to the merged Metis revision.
