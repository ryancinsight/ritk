...
- Status: in-progress; priority: P1; owner: RITK viewer + integration; integrator: root; last-update: 2026-09-18; lease: root `backlog.md`, `docs/manual/dicom-workflow.md`, `docs/manual/images/dicom-metis-real-mri.json` until hosted workflow evidence lands.
...
- Delivery: lock commit `a818f6f2e8c6bfc75f6026a1ce8a49e0d97610fd`; six Metis sources resolve at `dc938c0e359dac610867d5d09ddb659a1d221fef`; Moirai sources resolve at `7aa9d4e27fe8d12c0129accddccbf70bbc796e08`; standalone lock SHA-256 `50ababf8093f6ad2a2788012f8d6d0df9e1785a075600d7e3c0e5c63358387bc`.
- Evidence: native locked nextest 449/449 (lib) and 483/483 (package), native/WASM check and strict Clippy, format, lockfile and metadata checks pass; the real 94-file MRI replay exits 0, invalid-study probe exits 1, and produces the byte-identical 1280×800 PNG SHA-256 `259dd79103482756c4e688621bebafc841cc40f1df10ff2bbd7f9d04b7b4d401` with 411,589 non-black pixels; executable SHA-256 `3eb1d7b7b181b9a1600d17e38be35fff7b5ba93b6c8492a17df2a3ea3a4db7bd` (26,361,344 bytes). Hosted workflow evidence remains open.
