...
- Current increment: replace the fixed browser timer with Moirai's owned `WebAnimationFrame`; the frame future cancels its browser request on drop and keeps DICOM decoding, selection, geometry, and pixels in RITK.
...
- Current MRI visual refresh 2026-09-14: `scripts/viewer.py` reran the saved 94-file MRI-DIR T2 study through RITK `cc3270eaab28ceacea9242cec0a8854cc7afdcbc7`, Métis `80a5da5aebfbe2c7e43082886a0a1fff146b7aa7`, and Moirai `a7fa2ba69f25070581f7245f059089705d8fc699`. The process exited 0 and produced a deterministic 1280 × 800 frame with 411,589 non-black pixels and SHA-256 `259dd79103482756c4e688621bebafc841cc40f1df10ff2bbd7f9d04b7b4d401`; the current executable digest is `4032125b29b77c207a586e1957259f6216034c0f464dc4862cfffc6230bcd73b`. The canonical image and provenance were refreshed; private studies remain local.
