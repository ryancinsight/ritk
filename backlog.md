...
- Status: done; delivery: [PR #412](https://github.com/ryancinsight/ritk/pull/412), merge `c8a323c56746e9bbbb20e52dd48cb9b101b842eb`; implementation `c08749927`; last-update: 2026-09-16.
...
- Status: done; priority: P1; delivery: [RITK PR #407](https://github.com/ryancinsight/ritk/pull/407), merge `96bda4f9d3b38f4071ba31946f7e8f131da30f8b`.
- Outcome: RITK drops untrusted browser pointer, wheel and keyboard events before viewer translation; DICOM scanning, decoding and clinical presentation remain RITK-owned. [ADR 0035](docs/adr/0035-browser-event-trust.md) records the typed provider contract.
- Evidence: Metis `fb8b0a0b8169a580eb80028d0bbd519cf0057473` and Moirai `a1e83a15`; exact locked native `ritk-snap` nextest 820/820, native/WASM checks and strict Clippy, format, doctests and rustdoc passed.
...
- Evidence: current hosted [run 35133971196](https://github.com/ryancinsight/ritk/actions/runs/35133971196) builds RITK `db390b8616e4cc58f2555f49a816e61eed1fadd1` against Metis `88c60a0b6410c0e07700e965bcdbea43b7b20789`; Chromium/Firefox pass 94 file hashes, three exact pixel oracles, cine-rate/repeat checks, picker remount persistence and cleanup. WebKit accepts 94 files then fails the first bounded read; Chromium WebGPU reports no adapter. [Current artifacts and hashes](docs/manual/images/dicom-metis-real-browser-mri-cross-engine.json) record both residuals.
...
- Status: done; delivery: [RITK PR 249](https://github.com/ryancinsight/ritk/pull/249) and [Metis PR 31](https://github.com/ryancinsight/metis/pull/31).
...
## RITK-SNAP-FRAMES-001 — Complete multiframe opening [patch] — done
- Status: done; delivery: [`26074f364`](https://github.com/ryancinsight/ritk/commit/26074f364); RITK now opens scalar/RGB multi-frame DICOM from paths or bytes, preserving geometry and rejecting temporal, mixed-series, and malformed organizations.
...
- Status: done; delivery: [RITK PR #258](https://github.com/ryancinsight/ritk/pull/258), merge `ce6b60429`; decision: `docs/adr/0029-dicom-rgb-display.md`.
- Outcome: decoded RGB channels now reach all three orthogonal slice textures unchanged; scalar MIP, VR and fusion reject color volumes. Verification: 735/735 `ritk-snap` tests, 13/13 color IO tests, strict clippy, fmt, doctests, rustdoc and byte-equal manual captures.

<a id="RITK-SNAP-GRAYSCALE-001"></a>
## RITK-SNAP-GRAYSCALE-001 — DICOM grayscale presentation semantics [patch]
- Status: done; delivery: [RITK PR #259](https://github.com/ryancinsight/ritk/pull/259), merge `e52a4d28f`; decision: `docs/adr/0030-dicom-grayscale-presentation.md`.
...
- Status: in-progress; priority: P1; owner: RITK viewer + Métis framework; integrator: root; regions: `Cargo.lock`, `crates/ritk-snap/src/presentation/native_session`, `docs/adr/0026-viewer-presentation-migration.md`, `docs/manual/dicom-workflow.md`, `crates/ritk-snap/web/gallery/gallery.js`, `.github/workflows/metis-browser-dicom.yml`, `docs/adr/0037-browser-webgpu-presentation.md`, `docs/manual/images`, `backlog.md`; branch: `docs/close-ritk-snap-metis`; takeover: stale claim reclaimed 2026-09-17; last-update: 2026-09-17;
- Delivery: [RITK PR #293](https://github.com/ryancinsight/ritk/pull/293), merge `2bdce4910`; [RITK PR #334](https://github.com/ryancinsight/ritk/pull/334), merge `a3eef560b`; [RITK PR #342](https://github.com/ryancinsight/ritk/pull/342), merge `680e8abfe`; [RITK PR #343](https://github.com/ryancinsight/ritk/pull/343), merge `b5530674b`; [RITK PR #347](https://github.com/ryancinsight/ritk/pull/347), merge `b90715e916a7a4339aee2f24951a75ec4df6bd43`; [RITK PR #356](https://github.com/ryancinsight/ritk/pull/356), merge `ac34c573c02b8abe6f10685bba0e3f6944680c05`; [RITK PR #361](https://github.com/ryancinsight/ritk/pull/361), merge `2ff772647`; [RITK PR #363](https://github.com/ryancinsight/ritk/pull/363), merge `2595beb90`; [RITK PR #364](https://github.com/ryancinsight/ritk/pull/364), merge `0e1667773`; [RITK PR #365](https://github.com/ryancinsight/ritk/pull/365), merge `6709372eb`; [RITK PR #375](https://github.com/ryancinsight/ritk/pull/375), merge `2a8762e5f`; [RITK PR #386](https://github.com/ryancinsight/ritk/pull/386), merge `94b911f3956ab13fd6f2dad6968f61748650c628`; [RITK PR #387](https://github.com/ryancinsight/ritk/pull/387), merge `ea409f3c09a715b4f1b898b5738102a3832baf28`; [RITK PR #402](https://github.com/ryancinsight/ritk/pull/402), merge `3f5c35c98d82cd01d53e972cbb9dc174725bf3fb`; [RITK PR #404](https://github.com/ryancinsight/ritk/pull/404), merge `d9d1b92a35b34168798dd9fd6cea90b86b19cdc7`; [RITK PR #410](https://github.com/ryancinsight/ritk/pull/410), merge `4a0f962003bc1b81160d430ef3e6f515722ec053`; [RITK PR #425](https://github.com/ryancinsight/ritk/pull/425), merge `6ce6c6875`; risk: lost viewer behavior; decision: [ADR 0026](docs/adr/0026-viewer-presentation-migration.md).
- Completed browser-frame increment (2026-09-13, commit `600444285`): the browser loop now awaits Moirai's owned `WebAnimationFrame`; dropping the future cancels its browser request, while DICOM decoding, selection, geometry and pixels remain in RITK.
- Browser-frame evidence 2026-09-13: commit `600444285` rebuilt the WASM consumer against Moirai `fd3ec288`, and Edge 154 replayed the saved 94-file MRI-DIR T2 study. The run read 49,807,236 bytes, matched all three RGBA oracles, and closed cleanly; the canonical gallery image is byte-identical and its provenance now records the animation-frame schedule in [`dicom-metis-real-browser-mri-edge.json`](docs/manual/images/dicom-metis-real-browser-mri-edge.json).
- Acceptance extension: a lock-pinned Metis package contains the RITK executable, inventory and MSI, the portable executable opens a real saved DICOM study, and the per-user MSI installs and uninstalls without residue. DICOM behavior remains RITK-owned.
- Package deadline/local/hosted artifact increment (2026-09-15): RITK PR #402 merged at `3f5c35c98d82cd01d53e972cbb9dc174725bf3fb`, advancing all six Métis lock sources and workflow defaults to `c4276f2586f1ae9a1e3c0fa1dcb1507be4555f24`. The standalone package produced a 24,672,768-byte executable and 9,424,896-byte MSI; the packaged executable opened the committed 410-file public CT study and the per-user MSI install/uninstall lifecycle produced an identical 1280 × 800 three-plane capture with no residue. Hosted run [34990164849](https://github.com/ryancinsight/ritk/actions/runs/34990164849) completed successfully at head `3f5c35c98d82cd01d53e972cbb9dc174725bf3fb` and uploaded artifact `10406835672` (`ritk-snap-package`, digest `sha256:7772adcad26328ffad8eff114a93bfd7fb7974b38a146075013f004d92f90ec2`); its executable/MSI hashes are in [`dicom-metis-installer.json`](docs/manual/images/dicom-metis-installer.json). A local replay of the hosted executable rendered the same real CT capture; the hosted workflow checks packaging and `--help`, not DICOM execution or MSI lifecycle.
- Native cine/control increment (2026-09-14): Space toggles active-axis playback through the shared RITK presentation/action seam and repeated key-downs do not retrigger it. The native Métis session samples its bounded event-wait clock, advances the host-neutral `SnapApp::tick_cine_at` transition, and returns repaint requests so navigation and cine frames reach the retained surface; eframe and browser hosts retain their own clocks. Native `ritk-snap` nextest passes 811/811, with strict native Clippy, WASM library check/Clippy, and format gates passing.
- Native cine-rate increment (2026-09-14): [RITK PR #377](https://github.com/ryancinsight/ritk/pull/377), merge `0066b8113`, adds bounded 1–60 FPS `+`/`=` and `-` controls for native Métis and eframe, ignores repeated keydowns, reanchors timing, requests repaint, and exposes the active rate in the overlay. Locked `ritk-snap` nextest passes 814/814 with strict native and WASM Clippy/check gates.
- Browser cine-rate input increment (2026-09-15): [Metis PR #142](https://github.com/ryancinsight/metis/pull/142), merge `9413ed27c`, and [RITK PR #380](https://github.com/ryancinsight/ritk/pull/380), merge `79d6ad101`, deliver the `CanvasEvent` keyboard seam used by the browser adapter. `Equal`/`Minus` browser codes now reach the bounded 1–60 FPS reducer with repeat suppression, timing reanchoring and repaint signaling; RITK mapping/reducer tests pass. Hosted run [34973438029](https://github.com/ryancinsight/ritk/actions/runs/34973438029) proves focused `Equal`/`Minus` delivery and repeat suppression on Chromium 152 and Firefox 155; WebKit remains blocked on selected-file access. Edge cine-rate evidence remains recorded in [the saved-study capture](docs/manual/images/dicom-metis-real-browser-mri-edge.json).
- Browser cine-rate evidence: commits `2f7cc586d`, `997b6245a`, `f5ce64782`; Metis [PR #158](https://github.com/ryancinsight/metis/pull/158). The rebuilt Edge gallery accepts all 94 files, matches the three RGBA oracles and passes exact rate, fresh-frame, repeat-suppression and wheel assertions; [capture and limits](docs/manual/images/dicom-metis-real-browser-mri-edge.json).
- Native study-reopen increment (2026-09-15): the Moirai modifier snapshot now reaches RITK's native presentation events; an un-repeated `Ctrl+O` opens the existing bounded folder picker, decodes the selected study through RITK, resets viewer state and refreshes the Métis framebuffer. Picker cancellation preserves the current frame and decode errors leave the prior volume untouched. The focused reopen test loads a distinct grayscale DICOM fixture and asserts replacement geometry, paused cine and a new rendered frame; browser `Ctrl+O` remains browser-owned.
- Native study-reopen delivery (2026-09-15): [RITK PR #392](https://github.com/ryancinsight/ritk/pull/392), merge `3f46a08bf`, pins merged Metis modifier support at `63de785ed` and Moirai modifier snapshots at `8d032e38b`; final-lock `ritk-snap` nextest passes 833/833 with strict native and WASM check/Clippy gates.
- Native multi-series selector increment (2026-09-17): the Windows Métis session now scans ambiguous folders into an RITK-owned bounded selector, loads the exact highlighted SeriesInstanceUID after re-validation, and preserves the current study on Escape or decode failure. The selector renders over a valid framebuffer before the first load; native selector, exact UID, cancellation and failed-replacement tests are part of this branch. DICOM parsing, geometry and clinical display remain RITK-owned.
- Selector increment verification (2026-09-17): standalone locked `ritk-snap` library nextest passes 846/846 after the selector and recovery changes; strict all-target Clippy and workspace formatting also pass from the standalone repository context.
- WASM lint follow-up (2026-09-14): Windows keeps the manual Métis default while non-Windows and WASM derive `AppLaunchOptions::default`, so the strict `wasm32-unknown-unknown` Clippy gate remains warning-clean after the shell-default increment.
- Resize evidence increment 2026-09-13: the rebuilt `ritk-snap.exe` at `09958a00ae3beeb44a9a72724ae9eb17e71f81bc` opened the saved public MRI-DIR CT series through Metis `cf3b20c5cd11b28bc5ab442d3f1ff881269f7024`, captured all axial/coronal/sagittal planes at a 1280 × 800 client surface, applied a 1024 × 720 client resize, captured the same real DICOM study again, and exited with code 0. DPI stayed 96 and pixels changed; [before/after captures and provenance](docs/manual/images/dicom-metis-real-ct-resize.json). The saved local multi-series corpus was also opened locally with an explicit selector; its pixels remain outside committed artifacts.
- Saved-volume verification increment (2026-09-13): the tracked multi-series `test_data/2_skull_ct/DICOM` input fails closed without an explicit `SeriesInstanceUID`. Selecting one 111-slice CT series through the Windows `ritk-snap.exe --metis-native --capture-application` path produced a 1280 × 800 Métis framebuffer containing real axial (512 × 512), coronal and sagittal (512 × 111) views twice; both launches exited 0 and matched SHA-256 `f9d715f04eb1a536fa7aa06ebef90d2829e11d13a10df866db5c8550cdf8c190`. Captures remain local under ignored `output/`; no patient identifiers or pixels were committed.
- Build increment 2026-09-13: RITK's locked Metis packages now resolve the merged browser file-selection provider at `74ca9d6bda82e6a4728c1724f124faff5b848765` (Metis PR #102). The standalone lock check, native and `wasm32-unknown-unknown` all-target Clippy, and `ritk-snap` nextest pass `826/826`; RITK still owns DICOM scanning, selection, decoding, geometry, and clinical presentation.
- Current-provider visual increment 2026-09-13: the rebuilt Windows executable at RITK `7702bbc95d8455a58bc0c71db8601b6a12e85aac` and Metis `74ca9d6bda82e6a4728c1724f124faff5b848765` reproduces the committed public CT (`4fac3ea73e58325755c780de51c1b1504c0fc391da5c48ed2f578810ff46ddcb`) and MRI (`c7cc731c07b5d7e2c53697db34faecf98974d23fb34c1eac8d7e219dedfd32eb`) Métis captures with exit 0 and all three planes visible. A saved local multi-series folder fails without a selector and opens with one, while its private pixels remain ignored.
- Current MRI visual refresh 2026-09-14: `scripts/viewer.py` reran the saved 94-file MRI-DIR T2 study through RITK `f6e82835b856c55adcc1b97ad173686903e6a974`, Métis `ed3806811f23271310cb04078dff55aba5c90944`, and Moirai `a7fa2ba69f25070581f7245f059089705d8fc699`. The process exited 0 and produced a deterministic 1280 × 800 frame with 411,589 non-black pixels and SHA-256 `259dd79103482756c4e688621bebafc841cc40f1df10ff2bbd7f9d04b7b4d401`; the current executable digest is `4032125b29b77c207a586e1957259f6216034c0f464dc4862cfffc6230bcd73b`. The canonical image and provenance were refreshed; private studies remain local.
- Current-provider browser increment 2026-09-13: the rebuilt `wasm32-unknown-unknown` RITK viewer at `1547d2af4cbb58d7c0630e422b2b9903902c9811` accepted the saved public MRI-DIR T2 study through Metis `74ca9d6bda82e6a4728c1724f124faff5b848765` in the in-app Chromium host, read 94 files and `49,807,236` bytes, and reproduced the committed axial/coronal/sagittal canvas hashes (`9f7e4cc559348a784b13912958b5b25e03d425099737ee165a51b5e1e7dadfe1`, `f7af01f60af7e27f9e781e1f2d7a68a7be5ce2092f186486c7116c8280a005f3`, `de4fb44039edad6b7c94103d81ff9f0c9b7815f4287d1ca8539cdd5095f1e10e`) with non-black pixels on every canvas.
- Current increment (2026-09-14): the consumer validator now accepts an explicit keyboard mode that requires focused, trusted `ArrowDown` keydown/keyup evidence on every canvas, including key/code, repeat, modifiers and target checks. Keyboard traces add an `after-keyboard` semantic snapshot so wheel progression is compared with the state immediately before the wheel. The manual documents the `--require-keyboard` command and keeps keyboard records separate from DICOM pixel claims. Hosted run [34922946179](https://github.com/ryancinsight/ritk/actions/runs/34922946179) passes the keyboard and saved-study workflow on Chromium 152 and Firefox 155; Safari 26.6.2 accepts all 94 chooser entries but rejects the first bounded browser read before keyboard actions. The exact revisions, traces, artifact links and actual galleries are recorded in [`dicom-metis-real-browser-mri-cross-engine.json`](docs/manual/images/dicom-metis-real-browser-mri-cross-engine.json).
- Dependency-lock delivery (2026-09-15): all six Metis packages resolve to merged PR #153 at `fa7793be9b738859696ad566e012d69a763e55ca`; the provider lock update is merged as Metis PR #154 at `5f1bd8b8c3a0317e41d2e11d903edda5fdcda7cb`. All fifteen Moirai packages resolve to merged PR #344 at `3ccfb1b76f386321aa24a86e65fe81efdbdfad84`, and RITK PR #390 pins those revisions in the standalone lock and workflow. Hosted run [34922946179](https://github.com/ryancinsight/ritk/actions/runs/34922946179) then rebuilt RITK `37cca8684984498ce7bf179c9501f9dfec8dbcae` against Metis `fa7793be9b738859696ad566e012d69a763e55ca` and Moirai `3ccfb1b76f386321aa24a86e65fe81efdbdfad84`: Chromium 152 and Firefox 155 passed the real 94-file study, while Safari 26.6.2 rejected its first bounded read. The exact evidence is in [`dicom-metis-real-browser-mri-cross-engine.json`](docs/manual/images/dicom-metis-real-browser-mri-cross-engine.json).
- Provider-lock increment (2026-09-15): RITK PR #398 merged at `67ed6db952414d7b611e57a8100deead0eba7e88`; the standalone lock resolves all six Metis packages to `b374ca937ce6ddbcbce2fb55a0dd074a241ea956` and all fifteen Moirai packages to `2451a3155c44dcf76d5577e4eb8c08badde51a0a`, with the chooser workflow default pinned to Metis. Local locked package gates passed, including `ritk-snap` nextest 819/819, strict native/WASM checks and Clippy, format, and the lockfile validator. Hosted run [34973438029](https://github.com/ryancinsight/ritk/actions/runs/34973438029) passed the real 94-file MRI study on Chromium 152 and Firefox 155 with exact pixel, semantic, rejection, cine-rate and teardown evidence; Safari 26.6.2 accepted the chooser selection but failed its first bounded read, so the external WebKit authorization residual remains. DICOM parsing and image semantics remain RITK-owned.
- Post-lock browser evidence (2026-09-15): hosted run [34984468153](https://github.com/ryancinsight/ritk/actions/runs/34984468153) rebuilt RITK `15d3d3c3dd416b72cf901d652522c4877d38d664` against Métis `28a7c69da5991d5cd7cbf4bcdce40f826ed77e53` and Moirai `d95a2cd61b1f133a507d2735f5f72948a4ca5ec9`. Chromium 152 and Firefox 155 accepted the real 94-file MRI-DIR study, read 49,807,236 bytes, matched all three RGBA oracles, passed semantic/rejection/cine-rate/repeat/teardown checks, and produced the byte-identical canonical galleries. Safari 26.6.2 accepted the chooser selection but rejected the first bounded read; current WebKit sandbox diagnostics are recorded in [`dicom-metis-real-browser-mri-cross-engine.json`](docs/manual/images/dicom-metis-real-browser-mri-cross-engine.json).
- Provider lifecycle increment (2026-09-16): the standalone lock advances all fifteen Moirai packages to merge `5cf572f734a3a50cf57eafe67dd3723e7e303116`. The browser canvas presenter retains validated bitmap dimensions for same-size RGBA frames and resizes only after an extent change; DICOM decoding, geometry, clinical pixels and the existing real-study galleries remain unchanged. This guard removes redundant bitmap resets but supplies no WASM, browser-heap, process-memory or latency measurement.
- Provider lock integration (2026-09-16, Metis PR #175 merge `5662560c56af3b283e78a5f13bf3b59296c35845`): the standalone RITK lock advances all six Metis packages to that revision, and the browser chooser and Windows package workflows use it as their default. The lock keeps Moirai at canvas-provider merge `5cf572f734a3a50cf57eafe67dd3723e7e303116`; local consumer gates cover the updated graph, while hosted saved-study replay remains the acceptance step.
- Component-state increment 2026-09-13: the same live Chromium page reports the mounted Métis boundary, 31 active Rust-owned listener handles at generation 3, 94 accepted files and 49,807,236 bytes, Dark theme, released pointer state after a wheel-pan action, idle text composition, and the expected standalone no-backend state. The browser accessibility and DOM observations are captured in [`docs/manual/images/dicom-metis-real-browser-mri-components.json`](docs/manual/images/dicom-metis-real-browser-mri-components.json); the artifact contains no patient identifiers or DICOM metadata.
- Browser slice-progress increment 2026-09-13: RITK now rejects a browser trace when trusted wheel input leaves a multi-slice canvas index unchanged while allowing singleton axes to remain at zero. An Edge 154 WebDriver run loaded 409 public CT files through Métis, rendered non-black axial/coronal/sagittal canvases, and advanced indices 204→203, 256→255, and 256→255; initial/after screenshots and hashes, rejected oversized transfers, revisions, and teardown are recorded in [`docs/manual/images/dicom-metis-real-browser-ct-slice.json`](docs/manual/images/dicom-metis-real-browser-ct-slice.json). The `ritk-snap` package gate passes 828/828, with fmt, strict Clippy, doctests, rustdoc, and the trace validator passing.
- WASM memory increment 2026-09-13: two reloads of the same saved public MRI-DIR T2 study report identical committed linear-memory capacities of 1,769,472 bytes at initialization, 1,835,008 bytes after mount, and 404,160,512 bytes after decoding; [`docs/manual/images/dicom-metis-real-browser-mri-memory.json`](docs/manual/images/dicom-metis-real-browser-mri-memory.json) records the 64 KiB page counts and explicitly limits the observation to WebAssembly capacity, not allocator-used, browser-heap, native-process, compositor, or GPU memory.
- Edge browser increment 2026-09-13: Microsoft Edge 154.0.4258.12 accepted the saved public 94-file MRI-DIR T2 study through the bounded Métis runner, read 49,807,236 bytes, matched all three RITK RGBA oracles, rejected count/file/batch overflow inputs before reading, and closed cleanly; [manual captures and provenance](docs/manual/images/dicom-metis-real-browser-mri-edge.json). Residuals remain physical file-manager input, Firefox/WebKit, WebGPU and native dialog/process coverage.
- Cross-engine workflow increment 2026-09-14: hosted run [34858003647](https://github.com/ryancinsight/ritk/actions/runs/34858003647) built RITK `6fabf703c8770adb239aba9bbdf4e067050a73b4` against Métis `e3d1cdbcaf4065030f61a2f2a75765a729c5e203` and Moirai `3746941f810d696ced5bd7de6f1eb391e2857207`, then ran the saved 94-file public MRI-DIR T2 study through the standard W3C chooser on Chromium, Firefox, and WebKit. Chromium and Firefox matched the RITK RGBA oracle and canvas dimensions, reported the expected `data-ritk-*` attributes, rejected count/file/batch overflow before reading, processed trusted pointer and wheel input, and closed WebDriver cleanly. Safari 26.6.2 accepted the files but rejected the first bounded browser read and closed its session cleanly. The actual Chromium/Firefox galleries and per-engine outcome are recorded in [`dicom-metis-real-browser-mri-cross-engine.json`](docs/manual/images/dicom-metis-real-browser-mri-cross-engine.json); physical file-manager input, native dialog/process/permission coverage, WebGPU, and Safari's file-backed WebDriver read remain open.
- Adaptive canvas input increment 2026-09-13: Metis `abd6578caffb92ad4ab9011507cdd89fc0c2c7e2` derived in-bounds element-local offsets from CSS dimensions for the same study. Trusted pointer and wheel actions moved axial 47→46 and coronal/sagittal 256→255; all six actions, semantic snapshots, screenshots and teardown passed RITK validation. The canonical provenance records the offsets, listener release and session closure.
- Direct-file saved-study increment 2026-09-13: a real 512 × 512 DICOM image from the saved local corpus opened through `ritk-snap --metis-native --capture-application` and exited 0. The native Métis capture contains the stored axial pixels; singleton input leaves coronal and sagittal planes empty because no neighbouring slices were supplied. The private study, identifiers and capture remain local; the direct-file and explicit-series workflows are documented in [the Metis application manual](../metis/docs/manual/applications.md#open-a-saved-local-clinical-study).
- Increment 2026-09-13: target-specific warning gate keeps native GPU capture state and projection helpers out of the WASM library while retaining them for native tests; locked native and WASM all-target Clippy pass with `-D warnings`, and the focused `ritk-snap` nextest suite passes 818/818. Remaining migration gaps: Métis/WASM GPU presentation and Safari's file-backed WebDriver read.
- Increment 2026-09-12: `286a0b358` keeps changed GPU projections pending until matching readback and routes unsupported or failed requests to CPU; `6f821a0ed` records the repeated real-DICOM GPU capture in [manual provenance](docs/manual/images/dicom-eframe-real-gpu-ct.json). Residuals: Métis/WASM GPU presentation and Safari's file-backed WebDriver read; the current complete application-window capture is recorded in [manual provenance](docs/manual/images/dicom-metis-real-ct-window.json).
- Increment 2026-09-12: `b2772322f` bounds uniform scalar DICOM frame temporaries and releases scan payloads after reconstruction; 432/432 `ritk-io` nextest and strict Clippy pass, and three public CT runs through Métis exit 0 with a byte-identical capture. Mean peak private bytes fall from 2.74 GiB to 2.18 GiB (20.48%); [resource provenance](docs/manual/images/dicom-metis-real-ct-resource.json). Current application and complete-window captures remain byte-identical after `14a203acd` and `f1511e798` provenance refreshes.
- Automated real-study visual smoke increment (2026-09-13): `scripts/viewer.py` now accepts a caller-supplied saved DICOM path, runs it through the native Métis executable, decodes the resulting PNG with a bounded standard-library parser, and records dimensions and non-black pixel count. It does not copy the source path or pixels into tracked output; the private-study command remains local.
- Native compositor boundary increment (2026-09-13): the Métis session layout and geometry now accept RITK's `ViewportOffset` value, converting the legacy eframe pan state once at the native host boundary. Native presentation no longer carries `egui::Vec2`; the 13-test native-session slice passes.
- Host-neutral viewport state increment (2026-09-13): `SnapApp` now stores pan state as RITK `ViewportOffset`, and reset, load, close, pointer, and persisted-session paths use that value directly. Standalone locked `ritk-snap` nextest passes 828/828 with strict Clippy, formatting, and all-target checks; texture handles and dirty flags remain the eframe adapter's next extraction scope, while DICOM parsing and clinical presentation remain RITK-owned.
- Eframe render-resource boundary increment (2026-09-13): `EguiRenderState` now owns all eframe texture handles and `EguiApp` is the only eframe application wrapper; `SnapApp` retains viewer data, dirty flags, and slice bookkeeping without GUI texture types. Standalone locked `ritk-snap` nextest passes 828/828 in 116.004 seconds, strict Clippy and all-target check pass, and the rebuilt native host opens the saved 409-file public CT study and captures a 1280 × 800 frame with 359,857 non-black pixels (SHA-256 `8082cea87348126ce5a07cacb602bf71081747881481d2062bb1f2c7314113d3`). DICOM parsing, geometry, and clinical presentation remain RITK-owned.
- Host-neutral visual invalidation increment (2026-09-13): `SnapApp` now exposes one monotonic visual revision for transitions that invalidate retained render resources; `EguiRenderState` invalidates retained volume, projection, mesh, secondary-key and RT-DOSE resources against that revision. Per-texture dirty flags are removed from viewer state, while native Métis and browser presentation remain format-neutral. Locked all-target checks, strict Clippy, 828/828 nextest, and a saved public CT capture are the acceptance evidence. WASM library compilation passes; the pre-existing target-specific strict-Clippy dead-code gap remains tracked before full shell cutover. DICOM parsing, geometry and clinical presentation remain RITK-owned.
- Eframe scratch ownership increment (2026-09-14): `RenderBufferPool` now belongs to `EguiRenderState` and all eframe texture rebuilds borrow it there; `SnapApp` no longer carries eframe render scratch. The invalidation test proves texture resources clear while scratch capacity remains reusable. Locked all-target Clippy and the full 829/829 `ritk-snap` nextest suite pass; native Métis and browser presentation remain unchanged, with DICOM parsing, geometry and clinical presentation in RITK.
- Eframe texture rebuild boundary increment (2026-09-14, commit `ee0992814`): slice, projection and secondary-texture rebuilds now execute on `EguiRenderState` with an explicit `&mut SnapApp`, leaving all retained GUI textures and scratch storage in the eframe adapter. The viewer state and RITK presentation contracts remain host-neutral; offline package check, strict all-target Clippy and the focused projection-readiness nextest pass. DICOM parsing, geometry and clinical presentation remain RITK-owned.
- Host-neutral cine increment (2026-09-14, commit `eaa73b487`): `SnapApp::tick_cine_at` now owns timing and slice-advance decisions and returns typed `CineTick`; eframe only samples its clock and schedules repaint. Focused cine tests and the full 816-test `ritk-snap` nextest suite pass. DICOM parsing, geometry and clinical presentation remain RITK-owned.
- Browser cine increment (2026-09-14, commit `9d22e6f17`): the WASM viewer now feeds Moirai `WebAnimationFrame` timestamps into `SnapApp::tick_cine_at`; loading a new study stops playback and an advanced tick invalidates the browser surface. Native 816/816 nextest, strict native Clippy, locked WASM check, and strict WASM library Clippy pass. DICOM parsing, geometry and clinical presentation remain RITK-owned.
- Browser keyboard increment (2026-09-14): [RITK PR #379](https://github.com/ryancinsight/ritk/pull/379), merge `e524e14f7`, consumes the merged Métis PR #142 at `9413ed27ce6dc547bc566c481f4d36a17bc97e35` with Moirai `3ccfb1b76f386321aa24a86e65fe81efdbdfad84`. The browser canvas adapter maps bounded keydown/keyup records to RITK's shared virtual-key contract, preserves key-repeat state for cine controls, ignores unsupported codes, and assigns `tabindex="0"` so each canvas owns keyboard focus. Hosted run [34922946179](https://github.com/ryancinsight/ritk/actions/runs/34922946179) validates the real-study keyboard trace on Chromium 152 and Firefox 155; Safari's bounded read remains the provider residual.
- Keyboard evidence continuation (2026-09-15): hosted run [34922946179](https://github.com/ryancinsight/ritk/actions/runs/34922946179) validates focus and trusted `ArrowDown` traces on Chromium 152 and Firefox 155 for all three canvases. Safari 26.6.2 accepts all 94 chooser entries but rejects the first bounded browser read before keyboard actions; the exact failure artifact remains the WebKit provider regression case.
- Métis component increment (2026-09-14): native RITK chrome now uses `metis_ui_lang::DisplayList` for panel bars and labels while decoded `PresentationFrame` pixels remain RITK-owned and are blitted directly. The standalone lock advances Metis to `d8522334765ac905f4632cf2a2a6ecc3a5458e51` and Moirai to `a7fa2ba69f25070581f7245f059089705d8fc699`; focused native-session nextest passes 14/14, strict Clippy passes, and rebuilt public CT and four-panel MIP captures remain byte-identical at `8082cea87348126ce5a07cacb602bf71081747881481d2062bb1f2c7314113d3` and `989a1f66b43a39ec753180cdd882b08e11adfc2ab4009c416a694c1fd12efe42`.
- Exact-commit visual smoke (2026-09-14): RITK `5f91638d2` rebuilt the native executable and `scripts/viewer.py` opened the saved `test_data/2_skull_ct/DICOM` series through Métis with its explicit UID. The run exited 0, produced three visible orthogonal planes at 1280 × 800 with 140,020 non-black pixels, and matched SHA-256 `f9d715f04eb1a536fa7aa06ebef90d2829e11d13a10df866db5c8550cdf8c190`; visual inspection shows the real CT anatomy. The host-window wrapper also exited 0 with digest `1f2fabe6576cbaf059feff8fe1985a1bb2b22ed7e4293376ebef503e0a882ad4`. Captures stay in ignored `output/`; no patient identifiers or pixels were committed.
- Native picker increment (2026-09-14): done; delivery: `f92171c44`; Windows no-PATH selection of the saved public MRI-DIR T2 folder is verified through actual input injection. The interactive window displays all three RITK planes; pathless framebuffer capture matches explicit-path capture byte-for-byte (1280 × 800, 411,589 non-black pixels); both exit 0. Real dialog cancellation exits 1 before viewer creation. [Capture and provenance](docs/manual/images/dicom-metis-real-mri.json).
- Picker boundary evidence: four launch tests cover explicit-path bypass, folder forwarding, cancellation and typed provider-error propagation. Locked `ritk-snap` nextest passes 831/831 (run `322499d4-2581-4343-a2a5-2287894edca6`), strict all-target Clippy and workspace fmt pass, and the standalone lock resolves. Doctests pass 4/4 with one existing ignored example; warning-denied Rustdoc passes. Independent review finds no actionable issues. RITK retains all DICOM semantics; native OS permission-denial and unrelated host-migration acceptance remain open.
- Current default-shell evidence increment (2026-09-14, commit `45a4e3a05`): the merged Windows default shell reran the same saved public 409-file CT series three times through `scripts/viewer.py` and `scripts/resource.py`. Every run exited 0, rendered all three orthogonal planes at 1280 × 800 with 359,857 non-black pixels, rejected the invalid-study probe, and repeated SHA-256 `8082cea87348126ce5a07cacb602bf71081747881481d2062bb1f2c7314113d3`; the exact process-tree measurements and revisions are in [`dicom-metis-default-shell-ct.json`](docs/manual/images/dicom-metis-default-shell-ct.json).
- Legacy eframe viewport increment (2026-09-14): the unreferenced `ui::viewport` widget, egui texture/state model, and public re-export were removed; `SnapApp`, `PresentationFrame`, and the Métis canvas remain the active presentation path. The overlay-aware `ritk-snap` nextest suite passes 814/814, four documentation tests pass with one environment-only example ignored, and the rebuilt native executable opened the saved `test_data/2_skull_ct/DICOM` series through Métis with its explicit UID. The exact run exited 0 and produced three visible orthogonal planes at 1280 × 800 with 212,904 non-black pixels and SHA-256 `17d9fcfbc023608114d071ba030dbd43dcd1496a8d7ac442013890933ae8f1d7`; the capture is ignored local evidence and contains no committed patient pixels or identifiers.
- Windows default-shell increment (2026-09-14): `ritk-snap` now selects the existing Métis native host by default on Windows; `--eframe` is an explicit compatibility opt-out, and Métis-only capture/layout options are rejected by the eframe path. The eframe and Métis branches of `scripts/viewer.py` both pass: the real saved `test_data/2_skull_ct/DICOM` series opened without `--metis-native`, rendered three orthogonal planes at 1280 × 800, and produced the inspected SHA-256 `17d9fcfbc023608114d071ba030dbd43dcd1496a8d7ac442013890933ae8f1d7` capture; the explicit eframe baseline also exited 0 with its invalid-study rejection and visible capture.
- Python CI unblock increment (2026-09-13): the wheel smoke now installs the locally built wheel without re-resolving its already-installed test dependencies under `--no-index`; this fixes the matrix failure caused by pip searching for NumPy offline.
- Merged-main full-suite verification (2026-09-13): standalone `cargo nextest run --locked --manifest-path D:/atlas/repos/ritk/Cargo.toml -p ritk-snap --lib --tests` at `5dd17db33c271905902082b04ddc787fb1ce0bf1` passed 828/828 in 116.284 seconds, including the native session and browser-trace validators.
...
- Action-adapter increment: `ViewerViewport` maps validated display placement into RITK image coordinates; the eframe shell now feeds its pointer response through the shared event dispatcher and applies actions to `SnapApp`. `ImagePoint` and `ViewportOffset` remove egui point carriers from interaction state. Corrections preserve multi-click measurements, accumulate repaint requests, cancel lost-pointer gestures, carry fractional display coordinates without rounding, subtract large viewport origins before image-space narrowing, and route label, linked-cursor, and intensity consumers through the mapped image point. Verification: `ritk-snap` nextest 776/776, strict Clippy, formatting and package checks pass; DICOM loaders and clinical state remain RITK-owned.
- Wheel/modifier increment: [RITK PR #266](https://github.com/ryancinsight/ritk/pull/266), merge `7b0e24d5f`. RITK translates Moirai modifier snapshots and wheel deltas into the shared presentation/action path; Ctrl/Command wheel uses the existing zoom policy, plain vertical wheel steps the active slice, horizontal-only events preserve state, and malformed or out-of-viewport events cannot mutate state. The egui logical `command` alias maps to Ctrl while physical Meta remains separate. Métis remains transport/rendering only; DICOM parsing, decoded volume state, geometry and clinical semantics remain in RITK. Verification: 785/785 nextest, 19 focused seam tests, 3 doc-tests plus 1 ignored, synthetic DICOM visual workflow, standalone lock check (72 first-party sources), and all repository-hosted CI jobs pass.
- Native session increment: [RITK PR #267](https://github.com/ryancinsight/ritk/pull/267), merge `2f2058062`. The Windows `ritk-snap PATH --metis-native` path loads a real RITK study, renders the active slice through Métis's bounded native framebuffer, applies translated events, handles resize/minimize, DPI, focus cancellation and terminal lifecycle, and supports a finite hidden source-frame capture. Verification: 790/790 nextest, strict Clippy, Rustdoc, doctests, standalone lock check (72 first-party sources), and the Windows visual workflow pass; the external `recurseml/analysis` status errored independently.
- Native MPR increment: [RITK PR #269](https://github.com/ryancinsight/ritk/pull/269), merge `c1b8130bb`. The Windows host composes axial, coronal, and sagittal RITK frames with spacing-aware placement, routes pointer events to the selected panel, and captures a deterministic 1280 × 800 content framebuffer. Verification: 791/791 nextest, strict Clippy, Rustdoc, doctests, real Windows executable workflow, and a byte-equal reviewed manual image; DICOM opening and clinical display semantics remain in RITK.
- Browser handoff increment: the WASM launch mounts `metis-web`, drains its bounded named-byte batch into RITK's existing dropped-input classifier, and documents the HTML/JavaScript bootstrap. RITK remains the only DICOM owner. The standalone locked `wasm32-unknown-unknown` check and warning-denied Clippy pass after the merged [Mnemosyne #141](https://github.com/ryancinsight/Mnemosyne/pull/141) (`01f0bc59`), [Mnemosyne #143](https://github.com/ryancinsight/Mnemosyne/pull/143) (`be6efcb8`), [Coeus #393](https://github.com/ryancinsight/Coeus/pull/393) (`1140ee7f`), [Apollo #386](https://github.com/ryancinsight/apollo/pull/386) (`f8085085`), and [Leto #187](https://github.com/ryancinsight/leto/pull/187) (`569a32b8`) portability fixes.
- Packaging increment: RITK now owns the root `metis.json`, a single-binary manifest consumed by Métis `package`; `Cargo.lock` resolves all Métis packages at merged revision `4198390f2325b82f0a4852cc6bab59bd66a667ba`. It carries no DICOM or patient-data resources; the resulting portable executable and per-user MSI launch the RITK-owned loader and viewer. The local Windows x64 package smoke exited 0, recorded the executable and MSI hashes in ADR 0026, and passed `ritk-snap.exe --help`; `.github/workflows/metis-package.yml` provides the pinned manual hosted artifact path. Registry publication and signing remain release-authority work.
- Remaining host gap: real browser WebGPU output, physical/cross-engine browser input and complete-window capture; the explicit consumer entrypoints now exist, while current application-content and complete-window captures are recorded in [the manual provenance](docs/manual/images/dicom-metis-real-ct-window.json). Hosted installer artifact evidence remains a release workflow item.
- Completed increment: explicit SeriesInstanceUID startup selection now verifies RITK discovery membership before decoding, and eframe capture waits for the deferred load instead of failing on its first empty frame; unknown or ambiguous inputs fail closed. Verification: 816/816 `ritk-snap` nextest, strict all-target Clippy, fmt, doctests and rustdoc; saved local DICOM eframe and Métis captures exit 0, while no-selection and unknown-selection probes exit 1. Delivery: `e9d4a9292`. Private captures remain ignored.
...
- Completed increment: `WebCanvasPresenter` implements Metis's borrowed `CanvasFrame` seam for `PresentationFrame`; the adapter is compile-targeted and format-neutral. The later default-browser-entry increment moves `start_web` onto that direct Métis workflow while preserving its async JavaScript contract.
- Completed increment: `start_web_canvas` mounts the Métis browser host, routes its bounded named-byte drops through RITK's shared reducer, opens synthetic Part 10 DICOM bytes with the existing RITK loader, and presents one selected slice through Moirai's bounded canvas provider. `start_web_orthogonal_canvases` now presents axial, coronal and sagittal RITK frames through three named canvases from the same bounded handoff. Presentation tests and the [packaged three-canvas capture](docs/manual/images/dicom-metis-browser-three.png) assert the axis order and dimensions; pointer and wheel action routing is delivered, and the explicit asynchronous GPU entrypoints are recorded in the current browser WebGPU increment below.
- Explicit browser WebGPU increment (2026-09-16): the RITK presentation adapter exposes asynchronous single- and orthogonal-canvas GPU launchers over Metis's format-neutral `CanvasSurface`; the gallery selects them only for `?renderer=webgpu`, surfaces setup errors and never falls back to raster. DICOM decoding, geometry, pixels and viewer state remain in RITK. Metis PR #188 merged at `070af58f07d7dc762f181306d274099fb9fde0a8`; the standalone lock now pins that Metis revision and Moirai `21b66ba424ad8f50d8574d6e9714be696f807e82`. Overlay and standalone WASM checks, strict library Clippy, formatting and the locked `ritk-snap` library suite remain the acceptance gates; real browser GPU artifacts remain open.
- Browser WebGPU evidence increment (2026-09-16, completed): the saved-study matrix derives a dimensions-and-attributes oracle, runs Chromium with the RITK-owned `?renderer=webgpu` page query, and asks Metis for a named `webgpu` context plus real element PNGs. Raster entries keep the RGBA oracle; the WebGPU entry does not claim 2D equivalence or hardware acceleration. The standalone lock and workflow default pin Metis `88c60a0b6410c0e07700e965bcdbea43b7b20789` and Moirai browser PAL `95275651722583f52e098c0d30b1a53ec82c1fc7`. Hosted run [35133971196](https://github.com/ryancinsight/ritk/actions/runs/35133971196) records no browser WebGPU adapter in [artifact 10462807820](https://github.com/ryancinsight/ritk/actions/runs/35133971196/artifacts/10462807820) and the [failure capture](docs/manual/images/dicom-metis-real-browser-mri-webgpu-failure.png); successful GPU presentation remains an explicit host-capability gap.
- Hosted real-study evidence increment (2026-09-16): RITK PR #430 merged at `ac3c28a7354c5496dbe9f1fd083631fb8a25a831`; hosted run [35133971196](https://github.com/ryancinsight/ritk/actions/runs/35133971196) records the revision-bound Chromium/Firefox MRI captures, the Safari read residual and the unavailable WebGPU adapter in the [current provenance](docs/manual/images/dicom-metis-real-browser-mri-cross-engine.json). The [manual](docs/manual/dicom-workflow.md) embeds the actual rendered study and the WebGPU failure capture.
- Clean-main browser replay (2026-09-16): headless Chromium 152 accepted the same 94 saved MRI files through the W3C chooser, matched all three RGBA oracles, completed 50 trusted slice actions and 18 invalid-index probes, restored each start index, and closed with 24 diagnostic plus four transfer listeners removed; details are in [`dicom-metis-real-browser-mri.json`](docs/manual/images/dicom-metis-real-browser-mri.json).
- Clean-main native replay (2026-09-16): the bounded `scripts/viewer.py` harness opened all 94 saved MRI-DIR files through the Métis native surface at RITK `4a060dc75`, with locked Metis `88c60a0b` and Moirai `95275651`; exit 0, invalid-study probe exit 1, 1280 × 800 capture, 411,589 non-black pixels, and the canonical image digest are recorded in [`dicom-metis-real-mri.json`](docs/manual/images/dicom-metis-real-mri.json).
- WebGPU diagnostic increment (2026-09-16, completed): RITK's gallery renders string-valued WASM setup errors, preserving the no-adapter diagnostic in `gallery-status`; the current hosted trace confirms the setup failure without a raster fallback.
- WASM packaging increment: `ritk-snap` now builds as a `cdylib` library for `wasm32-unknown-unknown`; the lockfile resolves Mnemosyne at merged `be6efcb8`, and `wasm-bindgen 0.2.128 --target web --no-typescript` packages the runtime pair with `start_web`, `start_web_canvas`, and `start_web_orthogonal_canvases` exports. The release build, locked standalone/CI path, and live three-canvas browser capture are documented; physical/cross-engine browser input, GPU presentation, and complete application-window capture remain open.
- Completed increment: RITK PR #290 (`d6acfc3e`) routes the three Métis canvas presenters' bounded pointer and wheel listeners through the shared `PresentationEvent` reducer, preserves target-local coordinates and wheel units, routes orthogonal canvases by axis, and cancels lost gestures through `PointerCancel`. DICOM parsing, metadata, geometry, pixel presentation and viewer state remain RITK-owned. The locked consumer graph advances to Metis PR #64 at `58cf0259`; native, WASM, doctest, rustdoc and package gates pass. Decision: [ADR 0031](docs/adr/0031-bounded-browser-canvas-input.md).
- Physical-input transport increment (2026-09-11, [RITK PR #293](https://github.com/ryancinsight/ritk/pull/293)): the shared Métis W3C client now emits bounded trusted pointer-drag and wheel actions for named RITK canvases, while `ritk-snap` releases the Métis mount on browser-task failure before the task exits. RITK still owns DICOM decoding, geometry, clinical display and reducer state. Focused RITK verification and configured Chromium/Firefox/WebKit canvas captures remain required; no driver endpoint is configured in this environment.
- Host-geometry increment (2026-09-11, [RITK PR #293](https://github.com/ryancinsight/ritk/pull/293)): `ViewerViewport` now stores validated display origin and texel scale as finite `f64` pairs. Native eframe values convert at the host boundary; the RITK action mapper and browser path no longer carry egui coordinate types. DICOM parsing, geometry and viewer semantics remain RITK-owned.
- Dropped-input carrier increment (2026-09-11, [RITK PR #293](https://github.com/ryancinsight/ritk/pull/293)): RITK now classifies its own `DroppedInput` metadata/byte values. Native eframe conversion happens once at `app/panels.rs`; Métis browser payloads construct the same value directly. DICOM filename, MIME, Part 10 checks and byte-series loading remain RITK-owned, with no GUI carrier in the shared classifier.
- Default browser entry increment (2026-09-11, [RITK PR #293](https://github.com/ryancinsight/ritk/pull/293)): `start_web` keeps its asynchronous JavaScript contract but delegates to the direct Métis canvas workflow instead of starting an eframe `WebRunner`. `start_web_canvas` remains the synchronous single-canvas form and the orthogonal entrypoint remains available. DICOM classification, byte loading, geometry, presentation policy and viewer state remain RITK-owned; GPU presentation, trusted cross-engine input and complete application-window capture remain open.
- Consumer trace integration (2026-09-11, Metis [PR #72](https://github.com/ryancinsight/metis/pull/72)): the RITK manual now documents the format-neutral Metis canvas runner with RITK-owned canvas IDs and revision provenance. The runner records trusted browser transport and PNG evidence; RITK retains DICOM classification, decoded geometry, viewer actions and clinical pixel assertions. Configured Chromium/Firefox/WebKit traces remain open because no driver endpoint is available in this environment.
- Semantic snapshot increment (2026-09-11, [RITK PR #297](https://github.com/ryancinsight/ritk/pull/297), commit `7483870fc`): RITK publishes bounded `data-ritk-*` canvas attributes for load/frame state, axis, slice bounds and pixel dimensions after presentation. Unit tests cover empty/presented values; the attributes contain no patient or DICOM metadata and Métis remains format-neutral. Physical/cross-engine input, GPU presentation and complete-window capture remain open.
- Consumer semantic trace increment (2026-09-11, RITK [PR #299](https://github.com/ryancinsight/ritk/pull/299), Metis [PR #73](https://github.com/ryancinsight/metis/pull/73), commits `39ebbf356` and `fb4ad93`): the RITK manual gives the generic canvas trace its RITK-owned `data-ritk-*` allowlist. Metis captures values opaquely; RITK remains responsible for interpreting load/frame state, axis, slice bounds, dimensions and clinical assertions. Configured browser-driver evidence remains open.
...
- Actual-data visual increment (2026-09-11): the native Métis surface was rerun with the public MRI-DIR CT DICOM series; the 1280 × 800 axial/coronal/sagittal capture is reviewed in [the user manual](docs/manual/dicom-workflow.md), with its SHA-256 recorded there. The CC BY 4.0 phantom data remains the only committed image source; private clinical studies stay local.
- Actual-browser visual increment (2026-09-11): a Chromium host mounted the packaged `ritk_snap` WebAssembly module, accepted nine real MRI-DIR CT Part 10 files through Métis's bounded browser drop handoff, and presented non-black axial/coronal/sagittal canvases. The reviewed axial PNG and machine-readable provenance are [in the manual](docs/manual/dicom-workflow.md#inspect-an-actual-dicom-study-in-the-browser); physical drag-and-drop, Firefox/WebKit, WebGPU and full-window capture remain open.
- Full-series browser increment (2026-09-11, after merged Métis PR #75 (`be6235ab`) and Moirai PR #327 (`fd836cd1`)): the Codex Chromium workflow accepted all 409 saved MRI-DIR CT Part 10 files through the 512-entry, 256 MiB bounded handoff, read 216,156,416 bytes, and presented actual non-black axial (512 × 512; 124,466), coronal (512 × 409; 106,343), and sagittal (512 × 409; 140,317) canvases. The reviewed PNGs and hashes are in the manual provenance record; the public phantom remains the only committed image source. Physical drag-and-drop, Firefox/WebKit, WebGPU and complete-window capture remain open.
- Actual-MRI native increment (2026-09-11): the current Windows Métis surface accepted the saved MRI-DIR T2 DICOM series (94 files, 49,807,236 bytes), decoded it in RITK, and produced a reviewed 1280 × 800 axial/coronal/sagittal frame. The image and source/executable digests are recorded in [the workflow manual](docs/manual/dicom-workflow.md#capture-the-saved-mri-study-through-métis); the public phantom remains the only committed image source and private clinical studies stay local.
- Actual-MRI browser increment (2026-09-11): the Codex in-app Chromium host mounted the packaged RITK WASM viewer through Métis, accepted the same 94 saved DICOM files (49,807,236 bytes), and presented reviewed non-black axial (512 × 512), coronal (512 × 94), and sagittal (512 × 94) canvases. PNGs and hashes are recorded in [the workflow manual](docs/manual/dicom-workflow.md#inspect-the-saved-mri-study-in-the-browser); physical drag-and-drop, cross-engine, WebGPU and complete-window evidence remain open.
- Configured Edge browser increment (2026-09-11): Metis's pinned `browser_drop.py` ran the complete public 409-file MRI-DIR CT series through Edge 153.0.4234.19, matched the file and three-canvas RGBA oracles, rejected count/file/batch overflow, captured window/element PNGs and closed its W3C session. The updated RITK provenance is `docs/manual/images/dicom-metis-real-browser-orthogonal.json`; physical input, Firefox/WebKit, WebGPU and complete-window evidence remain open.
- Browser chooser increment (2026-09-12): the packaged RITK viewer consumed all 409 real public CT files through Metis `#file-input` and Moirai's bounded `selected_files` source, read 216,156,416 bytes, and reported ready presented axial, coronal and sagittal frames at 512 × 512, 512 × 409 and 512 × 409 pixels. The same path consumed the saved 94-file MRI study (49,807,236 bytes) and presented ready 512 × 512 axial and 512 × 94 coronal/sagittal frames. The live Chromium viewports showed non-black anatomy; the source revisions and exact DOM attributes are recorded in [the DICOM workflow manual](docs/manual/dicom-workflow.md#select-the-saved-study-through-the-browser-file-chooser). DICOM parsing, geometry, pixel values and viewer state remain RITK-owned; physical file-manager input, Firefox/WebKit and WebGPU remain open.
- GPU upload guard increment (2026-09-12, commit `697c22093`): eframe now preflights scalar volume sizes against both device buffer limits and routes oversized studies through the existing CPU projection path. The public 409 × 512 × 512 CT series exits 0 and renders the complete application; the byte-identical two-run capture and provenance are in [the eframe manual section](docs/manual/dicom-workflow.md#capture-the-saved-ct-study-in-eframe). Verification: 819/819 nextest, strict all-target Clippy, fmt, and a real saved-series eframe capture; GPU presentation for fitting volumes and configured browser-driver evidence remain open.
- Current visual refresh (2026-09-12): two independently launched eframe captures of the complete public 409-file CT are byte-identical at `f4b30c71bd57f54227f5eeec524cd72e93f56f68e834fed909b907f9ecace048`; the refreshed image and current RITK/Métis/executable revisions are recorded in [the eframe provenance](docs/manual/images/dicom-eframe-real-ct.json).
- Application-content capture increment (2026-09-12): the Windows Métis native path accepts `--capture-application` and draws bounded RITK plane, slice, frame-dimension, and window/level labels into the same framebuffer as the decoded public CT pixels. The existing `--capture` output remains pixel-only; the reviewed image and provenance are in [the DICOM workflow manual](docs/manual/dicom-workflow.md#capture-an-actual-dicom-study-through-métis). Complete operating-system window capture, GPU-capable Métis/WASM presentation, and cross-engine browser evidence remain open.
- Completed increment (2026-09-12): the public 409-file CT workflow now has a complete visible Métis HWND capture in addition to the deterministic framebuffer image, using Metis commit [`e4fcb0b`](https://github.com/ryancinsight/metis/commit/e4fcb0b41b514658115c4edb13688e02cfc3c925). The 1296 × 839 PNG includes the Windows frame and all three real RITK planes; provenance records the executable, stack revisions, dimensions and digest. Private studies remain local; GPU and cross-engine browser input remain open, while portable package execution is covered by the installer evidence increment above.
- Completed increment (2026-09-12): the explicit `orthogonal-with-mip` layout now has a complete visible Métis HWND capture of the same public 409-file CT. Two independent launches produced a byte-identical 1296 × 839 PNG showing axial, coronal, sagittal, and axial-MIP panels; [the image and provenance](docs/manual/dicom-workflow.md#capture-the-complete-mip-application-window) bind the source, executable, stack revisions, panel counts and orderly close. Private studies remain local; GPU and cross-engine browser input remain open, while portable package execution is covered by the installer evidence increment above.
...
- Outcome: default active graph excludes eframe/egui/rfd; `ritk-snap-eframe` retains the complete compatibility shell and capture workflow; documentation, ADR 0026, and lockfile are synchronized; real MRI-DIR rendering was inspected.
...
- **Status:** done; delivered by [RITK PR #229](https://github.com/ryancinsight/ritk/pull/229), merge `47a5d8b05901a2afa77bb558abc86ac675c5e223`; independent review approved the bounded-memory implementation and corrected boundary/error contracts.
...
## RITK-RIGID-CAPTURE-INITIALIZER-2026-09-04 — Robust rigid capture initializer [major] [arch] — done
...
- **SAFE-685-01 [patch] - Bound and document TIFF volume decoding**
  ...
  pass. Local implementation evidence: package formatting and warning-denied
  all-target Clippy pass; 18/18 focused tests pass in 0.162 seconds, including
  the public hostile-header regression; the
...
- **DOC-674-01 [patch] - Clarify and validate book figures**
  ...
  Replace placeholder and oversized per-pixel SVG output with labeled,
  raster-backed figures generated by real RITK algorithms; make N4 changes
  interpretable; add a binary morphology example that distinguishes opening
  from closing; correct the curvature-diffusion equation and review findings.
  Acceptance: examples compile and run within their finite budgets, generated
...
- **DOC-667-01 [patch] - Publish the RITK medical-imaging book**
  ...
  passed. PR #51 merged as `b3e12bc7`; the main-branch Pages deployment and
  live checks for the book and both SVG figures return HTTP 200.
...
- **CI-658-02 [patch] - Restore current PR compile gates (REVIEW;
  ...
  The corrected `burn_compat_types::world_to_index_tensor` now maps physical
  coordinates through direction and the required ZYX↔XYZ axis conversion.
  Focused image/interpolation nextest passes 166 tests with 3 explicitly
  skipped, including the fused/unfused contract.

- **CI-658-03 [patch] - Restore native Python color bindings (REVIEW;
  owner=Codex; scope=`crates/ritk-image/src/{color/native.rs,burn_compat_types.rs}`,
  `crates/ritk-filter/{src/color.rs,tests/native_color_components.rs}`,
  `crates/ritk-python/src/{color.rs,filter/{edge/canny.rs,smooth/gaussian.rs}}`,
  migration audit, PM artifacts).** Replace `PyColorImage`'s legacy color
  carrier with native `ColorVolume` and call native color/filter APIs with the
  concrete `MoiraiBackend` value. Native `ColorVolume` now owns validated
  component-buffer conversion, and color-component integration coverage uses
  that public contract. Correct the active legacy reference's rotated,
  anisotropic physical-to-index conversion so it agrees with the native
  innermost-first interpolation convention. Acceptance: `ritk-python` checks,
  warning-denied image/filter/Python Clippy, the 1,207-test package nextest
...
- **SEC-656-02 [patch] - Upgrade the DICOM JPEG XL dependency graph (IN
  PROGRESS; owner=Codex; scope=workspace DICOM dependencies, lockfile, PM
  artifacts).** Advance all DICOM crates from 0.8 to 0.10, which moves the
  registry JPEG XL chain from `jxl-grid` 0.5.3 to 0.6.2. Acceptance:
  `ritk-dicom` and `ritk-io` pass their focused nextest suites, then Kwavers
  consumes the merged RITK provider revision without the advisory.
