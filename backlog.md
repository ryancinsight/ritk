...
- Verification: dependency-free script tests, browser syntax/fixture checks, locked native/WASM package gates, and hosted responsive raster evidence. Hosted run [35690425860](https://github.com/ryancinsight/ritk/actions/runs/35690425860) passes Chromium and Firefox responsive jobs against RITK `27ac7d12` and Metis `ad27d214`; exact trace and derivative hashes are in `docs/manual/images/dicom-metis-real-browser-mri-responsive.json`.
...
- Verification: merged-main hosted run [35690425860](https://github.com/ryancinsight/ritk/actions/runs/35690425860) passes Chromium raster, Chromium window, Chromium MIP projection and Firefox on the 94-file public MRI-DIR study. The Chromium-window artifact [10678259838](https://github.com/ryancinsight/ritk/actions/runs/35690425860/artifacts/10678259838) records Length `102.75155`, Angle `3.5569937`, ROI Rect `5402.25`, ROI Ellipse `4146.0703` and HU Point `27.0`, seven rejected invalid probes, and listener cleanup from 21/34 mounted to 0/0 stopped. The Chromium raster artifact [10678605512](https://github.com/ryancinsight/ritk/actions/runs/35690425860/artifacts/10678605512), Firefox artifact [10677409856](https://github.com/ryancinsight/ritk/actions/runs/35690425860/artifacts/10677409856) and projection artifact [10678099827](https://github.com/ryancinsight/ritk/actions/runs/35690425860/artifacts/10678099827) bind exact RGBA/semantic evidence; WebKit artifact [10678219684](https://github.com/ryancinsight/ritk/actions/runs/35690425860/artifacts/10678219684) and WebGPU artifact [10678104679](https://github.com/ryancinsight/ritk/actions/runs/35690425860/artifacts/10678104679) remain explicit host-capability residuals.
...
- Evidence: current hosted [run 35690425860](https://github.com/ryancinsight/ritk/actions/runs/35690425860) builds RITK `27ac7d12bc69a04f7fb12e5ba41ef8fd4fe93aa9` against Metis `ad27d2148cc6b8fa9702cbbd4f37d9e106aa6535`; Chromium and Firefox pass the 94-file real MRI study, three exact pixel oracles and lifecycle checks; WebKit accepts the chooser but denies the first bounded read under Safari 26.6.2, with diagnostics artifact [10677994952](https://github.com/ryancinsight/ritk/actions/runs/35690425860/artifacts/10677994952) preserved in the provenance JSON.
...
- Blocker: exact SafariDriver/WebKit selected-file authorization defect remains external; current run 35690425860 reproduces the denial after SafariDriver accepts all 94 files (artifact [10678219684](https://github.com/ryancinsight/ritk/actions/runs/35690425860/artifacts/10678219684), diagnostics [10677994952](https://github.com/ryancinsight/ritk/actions/runs/35690425860/artifacts/10677994952)). Re-open when the corrected browser/runner path grants real-file reads; application byte-read APIs cannot grant that access.
...
- Blocker: hosted Chromium in run [35690425860](https://github.com/ryancinsight/ritk/actions/runs/35690425860) reports no WebGPU adapter; the setup error and failure capture artifact [10678104679](https://github.com/ryancinsight/ritk/actions/runs/35690425860/artifacts/10678104679) are preserved in [`dicom-metis-real-browser-mri-webgpu-failure.png`](docs/manual/images/dicom-metis-real-browser-mri-webgpu-failure.png).
