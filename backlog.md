...
- Delivery: lock merge `566df3d32`; six Metis sources resolve at `5e892245ac52c6455bbb57244fa654e6eb3cc9c1`; fifteen Moirai sources resolve at `ae282117fd962f4b7c66d722aad9d3c2906320bb`; standalone lock SHA-256 `a602ec28d9fb3d2c73b6245067ec33e4648d66434de07087b0153c90aea12fbb`.
- Evidence: native locked nextest 487/487 (449 library and 38 binary tests), native/WASM checks and strict Clippy, format, rustdoc, lockfile and metadata checks pass; browser trace validation accepts complete window-level and interaction attribute groups and rejects partial or unknown extensions; the real 94-file MRI replay exits 0, invalid-study probe exits 1, and produces the byte-identical 1280×800 PNG SHA-256 `259dd79103482756c4e688621bebafc841cc40f1df10ff2bbd7f9d04b7b4d401` with 411,589 non-black pixels; executable SHA-256 `05aa4f42b075fd3913d2c43a152148e2dc1f9a946729a278f7d2c0dbac068b88` (26,376,704 bytes). Hosted run [35395627386](https://github.com/ryancinsight/ritk/actions/runs/35395627386) passes the real 94-file/49,807,236-byte Chromium and Firefox galleries with exact three-plane RGBA oracles; budgeted manual captures are `b4709dadfedd91b28d0fdea3e104cc8ed6c98e726f6bfb568191386e99410242` (1,024×681) and `0ca18997b4d44d72ed39de04e6f3fea9a1ffb150d32389eb7482f5453bef81f5` (1,024×722), with full 2,880-pixel-wide captures retained in the hosted artifacts. WebGPU reports no adapter and the application-window cine probe remains a recorded residual; Safari accepted all 94 files but WebKit denied the first bounded read in the completed macOS job and its sandbox diagnostics are recorded.
