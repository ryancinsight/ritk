...
- Branch: `feat/ritk-browser-slice-progress-2026-09-13`; regions: `crates/ritk-snap/src/browser_trace.rs`, `crates/ritk-snap/src/browser_trace/tests.rs`, `docs/manual/dicom-workflow.md`, `docs/adr/0033-browser-trace-validator.md`, `docs/adr/README.md`; acceptance extension: a trusted wheel must advance every multi-slice canvas's declared slice index between initial and after-input snapshots, with singleton axes explicitly allowed.
