...
- Branch: `feat/ritk-snap-installer-evidence-001`; regions: `metis.json`, `docs/manual/dicom-workflow.md`, `docs/manual/images/dicom-metis-installer.json`, `docs/manual/images/dicom-metis-installer-ct.png`; acceptance extension: a lock-pinned Metis package contains the RITK executable, inventory and MSI, and the portable executable opens a real saved DICOM study. DICOM behavior remains RITK-owned.
