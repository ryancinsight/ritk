...
- Status: in-progress; priority: P1; owner: RITK viewer + Métis framework; integrator: root; branch: `docs/ritk-snap-metis-browser-evidence`; regions: backlog.md, docs/manual/dicom-workflow.md, docs/manual/images/dicom-metis-real-browser-mri-cross-engine.json; last-update: 2026-09-14;
