...
- Status: in-progress; priority: P1; owner: RITK viewer + Métis framework; integrator: root; regions: crates/ritk-snap/src/browser_trace.rs, crates/ritk-snap/src/main.rs, .github/workflows/metis-browser-dicom.yml, docs/manual/dicom-workflow.md; last-update: 2026-09-14;
