...
- Status: in-progress; priority: P1; owner: RITK viewer + Métis framework; integrator: root; regions: `Cargo.lock`, `crates/ritk-snap/web/gallery/gallery.js`, `.github/workflows/metis-browser-dicom.yml`, `docs/adr/0037-browser-webgpu-presentation.md`, `docs/manual/dicom-workflow.md`, `docs/manual/images`, `backlog.md`; last-update: 2026-09-16;
