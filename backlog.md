...
- Status: in-progress; priority: P1; owner: RITK viewer + Métis framework; integrator: root; last-update: 2026-09-13; branch: `docs/ritk-wasm-memory-evidence-001`; regions: `docs/manual/dicom-workflow.md`, `docs/manual/images/dicom-metis-real-browser-mri-memory.json`; delivery: [RITK PR #293](https://github.com/ryancinsight/ritk/pull/293), merge `2bdce4910`; risk: lost viewer behavior; decision: [ADR 0026](docs/adr/0026-viewer-presentation-migration.md).
