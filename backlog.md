...
- Status: done; priority: P1; delivery: [RITK PR #447](https://github.com/ryancinsight/ritk/pull/447), merge `e33d8268a`; last-update: 2026-09-17.
...
- Status: in-progress; priority: P1; owner: RITK viewer integration; integrator: root; last-update: 2026-09-18; dependency: Metis PR #239 merge `619832d15ac18a188ce6f79a0d810fcab7315891`.
...
- lease: root `Cargo.lock`, `docs/manual/images/dicom-metis-real-mri.json`, `docs/manual/dicom-workflow.md`, `backlog.md` 2026-09-18T02:20:00-04:00
...
- Status: done; priority: P1; integrator: root; last-update: 2026-09-17; delivery: PR #461, merge `ee0ded9e44a4d5a047d056f66736b65a6cbe4eec` (source `d810c18ac5f4ac7838f8dd043d4e4b28caa5e2d9`).
- Outcome: matched ITK's mixed overload by rounding spline numerator powers in `f32` before promotion to the double denominator; the 1-ULP assertion is stable without tolerance changes.
- Evidence: locked `ritk-filter` Nextest 1,075/1,075, focused parity 14/14, strict Clippy/format/diff checks, and local SimpleITK 2.5.6 denoising 1/1 pass. Post-merge CI `35246092760` and Python CI `35246090436` remain queued by hosted capacity; re-open only on a retro-check defect.
...
- Status: done; priority: P1; delivery: [PR #466](https://github.com/ryancinsight/ritk/pull/466) `13c7b40c4dd2342ae8149eda3a095c05c06c433f`, [PR #467](https://github.com/ryancinsight/ritk/pull/467) `678e7024a0f0d19acecff3dd53cea834d74c9c92`, [PR #468](https://github.com/ryancinsight/ritk/pull/468) `feb3ef827dbbd8b0e2d4d322a7ef1cbf53d64e32`, [PR #469](https://github.com/ryancinsight/ritk/pull/469) `bdccdc569b57021613df8a82bc9ae99119eb6146`; last-update: 2026-09-17.
- Outcome: RITK owns the bounded WASM window/level command, semantic centre/width attributes, and keyboard-accessible gallery controls; Métis remains format-neutral and DICOM decoding remains in RITK.
- Evidence: [hosted run 35269645902](https://github.com/ryancinsight/ritk/actions/runs/35269645902), [artifact #10518409508](https://github.com/ryancinsight/ritk/actions/runs/35269645902/artifacts/10518409508), 94 files/49,807,236 bytes; Brain T1 centre 500 width 800; six invalid probes rejected; all three generations 142→143 and RGBA digests changed; seven trusted events and five listener/input cleanups. WebGPU and Safari remain separate host-capability residuals.
