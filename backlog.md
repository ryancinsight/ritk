...
- Status: in-progress; priority: P1; owner: RITK viewer + Métis framework; integrator: root; branch: `docs/ritk-snap-metis-safari-evidence`; regions: backlog.md, docs/manual/dicom-workflow.md, docs/manual/images/dicom-metis-real-browser-mri-cross-engine.json, docs/adr/0031-bounded-browser-canvas-input.md, docs/adr/0033-browser-trace-validator.md; last-update: 2026-09-15;
- Lease: root — Cargo.lock, .github/workflows/metis-browser-dicom.yml, backlog.md, docs/manual/dicom-workflow.md, docs/manual/images/dicom-metis-real-browser-mri-cross-engine.json; 2026-09-15T01:20:00Z
