...
- Status: in-progress; priority: P1; owner: RITK viewer + Métis framework; integrator: root; regions: `Cargo.lock`, `.github/workflows/metis-browser-dicom.yml`, `docs/manual/dicom-workflow.md`, `docs/adr/0033-browser-trace-validator.md`, `docs/adr/0032-browser-semantic-snapshot.md`, `backlog.md`; last-update: 2026-09-15; branch: `main`;
