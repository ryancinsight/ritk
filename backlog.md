...
- Status: in-progress; priority: P1; owner: RITK viewer + Métis framework; integrator: root; branch: `feat/ritk-presentation-wheel`; last-update: 2026-09-10; risk: lost viewer behavior; decision: [ADR 0026](docs/adr/0026-viewer-presentation-migration.md).
...
- Claim: root; scope: format-neutral wheel/modifier actions and the RITK action adapter, with the native translation and DICOM manual updated in the same increment.
...
- Remaining host gap: reusable native/browser host loop, browser handoff, three orthogonal views, GPU presentation, native packaging and complete capture/manual snapshots through Métis.
