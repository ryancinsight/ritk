...
- Installer evidence increment 2026-09-13: Metis `6994a5f96fede946e71f1b77b28927ae923b0e75` packaged the RITK `e4179a2a8a904a974315b6da8b81abad9e5a1648` executable from the locked standalone graph into a portable `ritk-snap.exe`, matching `inventory.json` hashes and a 9,379,840-byte per-user MSI. The packaged executable opened the committed public 410-file MRI-DIR head CT study through `--metis-native`, rendered three non-black orthogonal planes, captured [the actual DICOM image](docs/manual/images/dicom-metis-installer-ct.png), and exited 0; the MSI installed, launched an identical capture, and uninstalled without registry or directory residue; [package provenance](docs/manual/images/dicom-metis-installer.json). WebGPU presentation and physical file-manager input remain separate gates.
