...
- Status: in-progress; priority: P1; owner: RITK viewer + integration; integrator: root; branch: `docs/ritk-metis-hosted-35759891764`; last-update: 2026-09-22; dependency delivery: PR [#604](https://github.com/ryancinsight/ritk/pull/604).
...
- Hosted verification: merged-main run [35759891764](https://github.com/ryancinsight/ritk/actions/runs/35759891764) passes the real 94-file study on Chromium, Chromium-window, Chromium MIP projection, responsive Chromium and Firefox lanes. WebKit accepts all 94 chooser paths but rejects the bounded whole-file read; Chromium WebGPU reports no adapter. Current artifact and source hashes are in [`dicom-metis-real-browser-mri-cross-engine.json`](docs/manual/images/dicom-metis-real-browser-mri-cross-engine.json).
