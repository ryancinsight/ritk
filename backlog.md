...
- Status: in-progress; priority: P1; owner: RITK viewer + Métis framework; integrator: root; branch: `feat/ritk-native-study-reopen`; regions: `crates/ritk-snap/src/presentation/events.rs`, `crates/ritk-snap/src/presentation/native.rs`, `crates/ritk-snap/src/presentation/web.rs`, `crates/ritk-snap/src/presentation/native_session.rs`, `crates/ritk-snap/src/presentation/native_session/tests.rs`, `docs/manual/dicom-workflow.md`, `docs/adr/0026-viewer-presentation-migration.md`, `backlog.md`; last-update: 2026-09-15;
- Lease: root — `crates/ritk-snap/src/presentation/events.rs`, `crates/ritk-snap/src/presentation/native.rs`, `crates/ritk-snap/src/presentation/web.rs`, `crates/ritk-snap/src/presentation/native_session.rs`, `crates/ritk-snap/src/presentation/native_session/tests.rs`, `docs/manual/dicom-workflow.md`, `docs/adr/0026-viewer-presentation-migration.md`, `backlog.md`; 2026-09-15T04:25:42Z
