...
- Status: in-progress; priority: P1; owner: RITK viewer + Métis framework; integrator: root; last-update: 2026-09-11; delivery: [RITK PR #293](https://github.com/ryancinsight/ritk/pull/293), merge `2bdce4910`; risk: lost viewer behavior; decision: [ADR 0026](docs/adr/0026-viewer-presentation-migration.md).
...
- Lease: Codex `crates/ritk-snap/src/dicom/loader/`, `crates/ritk-snap/src/presentation/native_session.rs`, `crates/ritk-snap/src/launch.rs`, `crates/ritk-snap/src/main.rs`, focused tests, README, migration guide, manual, and ADR 0026; 2026-09-12.
- Current increment: allow a native Métis launch to select one discovered SeriesInstanceUID from a mixed DICOM directory; no arbitrary-series fallback and no DICOM logic leaves RITK.
