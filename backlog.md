...
- Remaining host gap: reusable native/browser host loop, wheel/modifier parity, browser handoff, three orthogonal views, GPU presentation, native packaging and complete capture/manual snapshots through Métis.
