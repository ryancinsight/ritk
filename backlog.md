...
- Consumer semantic trace increment (2026-09-11, Metis [PR #73](https://github.com/ryancinsight/metis/pull/73), commit `fb4ad93`): the generic canvas trace captures the RITK-owned `data-ritk-*` values under bounded opaque snapshots. RITK remains responsible for interpreting load/frame state, axis, slice bounds, dimensions and clinical assertions; configured browser-driver evidence remains open.
