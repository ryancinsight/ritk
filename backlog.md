...
- Status: in-progress; priority: P1; owner: RITK viewer + Métis framework; integrator: root; branch: `build/ritk-snap-moirai-stream-portable-lock`; regions: Cargo.lock, backlog.md, crates/ritk-snap/src/browser_trace.rs, crates/ritk-snap/src/main.rs, .github/workflows/metis-browser-dicom.yml, docs/manual/dicom-workflow.md; last-update: 2026-09-14;
...
- Dependency-lock increment (2026-09-14): the browser consumer lock resolves all six Metis packages to merged Metis `02d4047c5567834667ab9beb796ea27f6257f0ad` and all Moirai packages to merged `3213b24b01ae06047f11428384599670e4f5df25` from Moirai PR #341; standalone lock resolution, WASM check and strict Clippy, native strict all-target Clippy, and `ritk-snap` nextest `830/830` pass. A hosted saved-study rerun with this provider revision remains pending.
