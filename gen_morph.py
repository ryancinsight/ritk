...
# hit_or_miss.rs
hit_or_miss = """//! Binary hit-or-miss transform for 3-D images.
//!
...
wf(r"D:/ritk/crates/ritk-core/src/filter/morphology/hit_or_miss.rs", hit_or_miss)
print("Written hit_or_miss.rs")

# top_hat.rs
top_hat_lines = []
top_hat_lines.append("""//! White and black top-hat filters.
""")
top_hat_lines.append("""//!
""")
top_hat_lines.append("""//! WTH_B(f) = f - opening_B(f)
""")
top_hat_lines.append("""//! BTH_B(f) = closing_B(f) - f
""")
top_hat_lines.append("""
""")
top_hat_lines.append("""use super::grayscale_dilation::GrayscaleDilation;
""")
top_hat_lines.append("""use super::grayscale_erosion::GrayscaleErosion;
""")
top_hat_lines.append("""use crate::image::Image;
""")
top_hat_lines.append("""use burn::tensor::backend::Backend;
""")
top_hat_lines.append("""
""")
top_hat_lines.append("""#[derive(Debug, Clone)]
""")
top_hat_lines.append("""pub struct WhiteTopHatFilter { pub radius: usize }
""")
top_hat_lines.append("""impl WhiteTopHatFilter {
""")
top_hat_lines.append("""    pub fn new(r: usize) -> Self { Self { radius: r } }
""")
top_hat_lines.append("""    pub fn with_radius(mut self, r: usize) -> Self { self.radius = r; self }
""")
top_hat_lines.append("""    pub fn apply<B: Backend>(&self, image: &Image<B, 3>) -> anyhow::Result<Image<B, 3>> {
""")
top_hat_lines.append("""        let eroded = GrayscaleErosion::new(self.radius).apply(image)?;
""")
top_hat_lines.append("""        let opened = GrayscaleDilation::new(self.radius).apply(&eroded)?;
""")
top_hat_lines.append("""        sub_clamp(image, &opened)
""")
top_hat_lines.append("""    }
""")
top_hat_lines.append("""}
...
top_hat_lines.append("""#[derive(Debug, Clone)]
""")
top_hat_lines.append("""pub struct BlackTopHatFilter { pub radius: usize }
""")
top_hat_lines.append("""impl BlackTopHatFilter {
""")
top_hat_lines.append("""    pub fn new(r: usize) -> Self { Self { radius: r } }
""")
top_hat_lines.append("""    pub fn with_radius(mut self, r: usize) -> Self { self.radius = r; self }
...
top_hat_lines.append("""    pub fn apply<B: Backend>(&self, image: &Image<B, 3>) -> anyhow::Result<Image<B, 3>> {
""")
top_hat_lines.append("""        let dilated = GrayscaleDilation::new(self.radius).apply(image)?;
""")
top_hat_lines.append("""        let closed = GrayscaleErosion::new(self.radius).apply(&dilated)?;
""")
top_hat_lines.append("""        sub_clamp(&closed, image)
""")
top_hat_lines.append("""    }
""")
top_hat_lines.append("""}
