...
- [x] Remove seven duplicate registration invocations from side-by-side tests
...
- [x] Replace public mutable state with validated configuration and one input-sensitive core.
- [x] Add exact legacy/native execution and migrate PyO3.
- [x] Add parameter-sensitivity, boundary, and independent SimpleITK regressions.
- [x] Run package gates and adversarial review; commit and push close the delivery cycle.

## MIG-649-01 — Native Toboggan watershed
**Target version**: 0.14.0 migration batch
- [x] Extract and validate the canonical flat Toboggan core.
- [x] Add exact legacy/native execution with geometry preservation.
- [x] Migrate PyO3 to the native owner and typed validation errors.
- [x] Preserve label-exact SimpleITK 2-D/3-D fixtures and add boundary regressions.
- [x] Run package gates, adversarial review, commit, and push.
...
**Target version**: 0.14.0 migration batch
- [x] Specify finite-relief, cardinality, deterministic-order, and exact-label contracts.
- [x] Add validated filter-owned native execution over the canonical flat core.
- [x] Migrate CLI and PyO3 consumers to native images.
- [x] Add exact differential, boundary, CLI, and wheel regressions.
- [x] Run package gates, adversarial review, commit, and push.
...
## MIG-578-01 — Snap native curvature flow
**Target version**: 0.14.0 migration batch
- [x] Extract shared stencil, route native Snap, and verify constant-field invariance.
...
- [x] Expose the canonical global-CDF equalization kernel through a native image
  boundary.
- [x] Route Snap histogram equalization through that provider boundary.
- [x] Verify exact CDF mapping, metadata, and warning-denied Clippy; commit and
